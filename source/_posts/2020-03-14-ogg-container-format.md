...
![裸的二进制包缺乏分割标志，拼在一起将无法被处理](/images/ogg_container_format/1.png)
...
![将裸的二进制流封装之后成为物理流](/images/ogg_container_format/2.png)
...
![多个流复合成一个流](/images/ogg_container_format/3.png)
...
![位置数与包大小和排列的关系](/images/ogg_container_format/5.png)
